...
DOCKER_ALIAS_CLI_BINARY="$DOCKER_ALIAS_ROOT/cli"
DOCKER_ALIAS_CLI_SYMLINK="$USER_BIN_DIR/docker-alias"

DOCKER_ALIAS_DAEMON_SYSTEMD_FILE="docker-alias.service"
DOCKER_ALIAS_DAEMON_SYSTEMD_UNIT_PATH="$DOCKER_ALIAS_ROOT/$DOCKER_ALIAS_DAEMON_SYSTEMD_FILE"
...
if [ -L "$DOCKER_ALIAS_DAEMON_SYSTEMD_SYMLINK" ]; then rm "$DOCKER_ALIAS_DAEMON_SYSTEMD_SYMLINK"; fi
